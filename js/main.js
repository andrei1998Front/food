...
function calc() {
  ...
  function calcTotal() {
    ...
    var female = Math.round((447.6 + 9.2 * weight + 3.1 * height - 4.3 * age) * ratio);
    var male = Math.round((88.36 + 13.4 * weight + 4.8 * height - 5.7 * age) * ratio);
...
/* harmony import */ var _services_services_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../services/services.js */ "./js/services/services.js");
...
function cards() {
  ...
  (0,_services_services_js__WEBPACK_IMPORTED_MODULE_14__.getResource)("http://localhost:3000/menu").then(function (data) {
...
/* harmony import */ var _modal_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modal.js */ "./js/modules/modal.js");
/* harmony import */ var _services_services_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/services.js */ "./js/services/services.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindSendingForms(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_services_services_js__WEBPACK_IMPORTED_MODULE_10__.sendingForms)('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    (0,_modal_js__WEBPACK_IMPORTED_MODULE_9__.openModal)('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modal_js__WEBPACK_IMPORTED_MODULE_9__.closeModal)('.modal');
    }, 4000);
  }
}
...
function slider(_ref) {
  ...
  var slideIndex = 1;
  var offset = 0;
  total.textContent = slides.length < 10 ? "0".concat(slides.length) : slides.length;
  current.textContent = slideIndex < 10 ? "0".concat(slideIndex) : slideIndex;
  sliderField.style.width = "".concat(100 * slides.length, "%");
  ...
  var dotArr = document.querySelectorAll(".dot");
  dotArr[slideIndex - 1].classList.add("dot_active");
  dotArr.forEach(function (dot) {
    dot.addEventListener("click", function (e) {
      var dotNum = +e.target.getAttribute("data-dotNum");
      var offset = getValue(width) * dotNum;
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  var tabContainer = document.querySelector(tabsParentSelector),
...
var sendingForms = /*#__PURE__*/function () {
  ...
  return function sendingForms(_x, _x2) {
...
/* harmony import */ var _modules_cards_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/cards.js */ "./js/modules/cards.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer_js__WEBPACK_IMPORTED_MODULE_3__["default"])('2023-01-22', '.timer');
  ...
  (0,_modules_cards_js__WEBPACK_IMPORTED_MODULE_7__["default"])();
});
})();
